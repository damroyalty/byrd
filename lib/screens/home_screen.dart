...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _updateMarqueeDuration(double scrollWidth) {
    if (scrollWidth != _lastScrollWidth && scrollWidth > 0) {
      ...
      final duration = Duration(milliseconds: (1000 * scrollWidth / _marqueeSpeed).round());
    ...
    final birdsWithReplacement = Provider.of<BirdsProvider>(context).birds
        .map((bird) {
          ...
          if (bird.type == BirdType.chicken) {
            final match = RegExp(r'([A-Za-z]+) Color/Type: ([^\n]+)').firstMatch(notes);
          ...
          final displayText = '${bird.typeName} | $breedDisplay | ${bird.location} | Replacement: $formattedDate';
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search breed/location',
                      hintStyle: TextStyle(fontSize: 11, color: isDark ? Colors.white70 : Colors.black87),
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide.none,
                      ...
                      prefixIcon: Icon(Icons.search, size: 20, color: isDark ? Colors.white70 : Colors.black54),
                ),
                onSubmitted: (query) {
            ...
            if (birdsWithReplacement.isNotEmpty)
              SizedBox(
                  ...
                  builder: (context, constraints) {
                    ...
                    for (var i = 0; i < birdsWithReplacement.length; i++) {
                      final entry = birdsWithReplacement[i];
                          final displayText = entry['displayText'] as String;
                          final replacementDateObj = entry['replacementDate'] as DateTime?;
                          ...
                          // highlighted date //
                          final dateStr = replacementDateObj != null ? formatReplacementDate(replacementDateObj) : '';
                          final beforeDate = displayText.substring(0, displayText.lastIndexOf(dateStr));
                          final afterDate = displayText.substring(displayText.lastIndexOf(dateStr) + dateStr.length);
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ...birdsWithReplacement.asMap().entries.map((entry) {
                                              final idx = entry.key;
                                              final birdEntry = entry.value;
                                              final displayText = birdEntry['displayText'] as String;
                                              final replacementDateObj = birdEntry['replacementDate'] as DateTime?;
                                              final daysDiff = birdEntry['daysDiff'] as int;
                                              Color textColor = daysDiff <= 90 ? Colors.red : Colors.green[900]!;
                                              final birdsProvider = Provider.of<BirdsProvider>(ctx, listen: false);
                                              final allBirds = birdsProvider.birds;
                                              Bird? matchingBird;
                                              try {
                                                matchingBird = allBirds.firstWhere(
                                                  (b) => extractReplacementDate(b.notes) == replacementDateObj && displayText.contains(b.breed) && displayText.contains(b.location),
                                                );
                                              } catch (_) {
                                                matchingBird = null;
                                              }
                                                      ...
                                                      ? () {
                                                          ...
                                                          showDialog(
                                                            ...
                                                            builder: (infoCtx) {
                                                              ...
                                                              void showImagePopup(String imgPath, {List<String>? allImages}) {
                                                                int initialIndex = 0;
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            const Spacer(),
                                                                            IconButton(
                                                                              icon: Icon(Icons.edit, color: customTileGreen, size: 22),
                                                                              tooltip: 'Edit',
                                                                              onPressed: () {
                                                                                Navigator.of(infoCtx).pop();
                                                                                Navigator.push(
                                                                                  context,
                                                                                  MaterialPageRoute(
                                                                                    builder: (context) => AddEditBirdScreen(birdToEdit: bird),
                                                                                  ),
                                                                                );
                                                                              },
                                                                            ),
                                                                        ...
                                                                        if (bird.imagePath != null && bird.imagePath!.isNotEmpty)
                                                                          Center(
                                                                            child: GestureDetector(
                                                                              onTap: () => showImagePopup(bird.imagePath!),
                                                                              child: ClipRRect(
                                                                        ...
                                                                        SelectableText.rich(
                                                                          TextSpan(
                                                                            style: valueStyle,
                                                                            children: [
                                                                              TextSpan(text: 'Breed: ', style: labelStyle),
                                                                              TextSpan(text: bird.breed + '\n'),
                                                                              TextSpan(text: 'Quantity: ', style: labelStyle),
                                                                              TextSpan(text: '${bird.quantity}\n'),
                                                                              TextSpan(text: 'Location: ', style: labelStyle),
                                                                              TextSpan(text: bird.location + '\n'),
                                                                              if (bird.notes.isNotEmpty) ...[
                                                                                TextSpan(text: 'Notes: ', style: labelStyle),
                                                                                TextSpan(text: bird.notes),
                                                                              ],
                                                                            ],
                                                                          ),
                                                                        ...
                                                                        if (bird.additionalImages.isNotEmpty)
                                                                          Padding(
                                                                            ...
                                                                            child: Wrap(
                                                                              spacing: 10,
                                                                              runSpacing: 10,
                                                                              children: bird.additionalImages.map((imgPath) => 
                                                                                GestureDetector(
                                                                                  onTap: () => showImagePopup(imgPath, allImages: bird.additionalImages),
                                                                                  child: ClipRRect(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Icon(Icons.egg, size: 16, color: Colors.yellow[800]),
                                                        ),
                                                              Expanded(
                                                                child: Text(
                                                            displayText,
                                            ...
                                            if (birdsWithReplacement.isEmpty)
                                              const Padding(
                                                padding: EdgeInsets.symmetric(vertical: 12.0),
                                                child: Text('No upcoming replacements.', style: TextStyle(color: Colors.grey)),
                                              ),
                                          ],
                                        ),
                                      ),
                ...
                Row(
                  ...
                  children: [
                    const Icon(Icons.dark_mode, size: 15, color: Colors.brown),
                    const SizedBox(width: 4),
                    Text('Dark Mode', style: TextStyle(fontSize: 12, color: Colors.brown)),
                    const SizedBox(width: 4),
                    Transform.scale(
                      scale: 0.75,
                      child: Switch(
